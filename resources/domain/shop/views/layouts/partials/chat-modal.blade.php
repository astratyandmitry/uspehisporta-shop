<div class="chat-modal" x-data="{open: true}" x-show="open && !localStorage.getItem('modalChatClosed')">
  ...
  <div class="chat-modal__content">
    <div class="chat-message">
      ...
      <p>
        <a href="https://t.me/uspehisportachat" target="_blank" class="i-button i-button--fill">
          Подписаться
        </a>
      </p>

      <p>
        <span class="chat-message__close" x-on:click="closeModal(() => open = false)">Закрыть</span>
      </p>
    </div>
  </div>
</div>
