        ...
        <div class="swiper-wrapper">
          @foreach($mainBanners as $mainBanner)
            <a href="{{ $mainBanner->url }}" target="_blank" class="swiper-slide slide">
              <img src="{{ image_url($mainBanner->image) }}" alt="{{ $mainBanner->title }}" class="slide__image">
              <img src="{{ image_url($mainBanner->image_mobile) }}" alt="{{ $mainBanner->title }}" class="slide__image slide__image--mobile">
            </a>
          @endforeach
        </div>
